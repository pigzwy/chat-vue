// 品牌图标(SVG path 取自 iconify 数据:mingcute grok-fill / simple-icons openai,均宽松许可)
// 与 lucide 图标同型的 className 接口,currentColor 跟随文本色

export function GrokIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true" fill="currentColor">
      <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm-3.4 4.2a1 1 0 0 0-1.4.2l-6 8a1 1 0 1 0 1.6 1.2l6-8a1 1 0 0 0-.2-1.4" />
    </svg>
  )
}
