...
export function EditHistoryPanel() {
  ...
  return (
    <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-label="编辑历史">
      <button
        type="button"
        aria-label="关闭"
      ...
      />
      <div className="glass-panel glass-panel--lg absolute inset-y-0 right-0 m-3 flex w-[calc(100%-1.5rem)] max-w-md flex-col overflow-hidden rounded-3xl animate-fade-scale">
